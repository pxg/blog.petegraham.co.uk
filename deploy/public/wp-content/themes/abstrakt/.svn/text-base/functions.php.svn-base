...
// WP-abstrakt Pages Box 
 function widget_abstrakt_pages() {
?>
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Pages'), 'widget_abstrakt_pages');


// WP-abstrakt Search Box 
 function widget_abstrakt_search() {
?>
...
if ( function_exists('register_sidebar_widget') )
    register_sidebar_widget(__('Search'), 'widget_abstrakt_search');
